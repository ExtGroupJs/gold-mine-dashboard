# Script para iniciar solo Celery Worker
# Útil cuando quieres ejecutar el worker de forma independiente
...
# --pool=solo es necesario en Windows para compatibilidad
