...
class GenericModelAdmin(admin.ModelAdmin):
    ...
    def __init__(self, model, admin_site):
        ...
        self.all_fields = [field.name for field in model._meta.get_fields(include_parents=False)]
        ...
        for field_name in self.all_fields:
            try:
                ...
                self._field_info[field_name] = {
                    'is_reverse': field.auto_created and (
                    ...
                    'is_filterable': isinstance(
                        ...
                        (
                            ...
                            models.IntegerField, models.ForeignKey, models.ManyToManyField
                        )
        ...
        self.raw_id_fields = [
            field for field in self.all_fields 
            if self._field_info[field]['is_m2m'] and not self._field_info[field]['is_reverse']
        ]
        self.search_fields = [
            field for field in self.all_fields 
